          ...
          <>
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 rounded-lg bg-black hover:bg-gray-900 text-white font-medium transition-colors border border-gray-700"
              >
